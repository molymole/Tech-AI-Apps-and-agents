...
Now that MH has seen a simple proof of concept application using a single-agent architecture, they would like to extend this application to support multiple agents. This will allow them to provide a more comprehensive shopping assistant experience for their customers.
...
In this task, you will develop out multiple agents to satisfy the requirements of the MH shopping assistant. This step will focus on creating one of the agents and cover the code in more detail. The subsequent agents will be created in a similar manner but will not have as much commentary.
...
initialize_agent(
    ...
    description="MH Customer Loyalty Agent",
...
========================================
- You are a Interior Designer sales person working for MH and help customers who need help in DIY Projects and other interior design queries
...
initialize_agent(
    ...
    description="MH Interior Design Agent",
...
initialize_agent(
    ...
    description="MH Inventory Agent",
...
========================================
- You are the public facing assistant of MH
...
initialize_agent(
    ...
    model=os.environ["gpt_deployment"],
    name="cora",
    description="Cora - MH Shopping Assistant",
...
```plaintext
You are a Cart Manager Assistant for MH, a home improvement and furniture retailer.
...
7. SPECIAL INSTRUCTIONS
   ...
   - On checkout, display the cart contents and tell the customer that they may pick up their products from the closest MH retail outlet, located in Miami, Florida. Only give this information when the customer requests to check out.
...
initialize_agent(
    ...
    model=os.environ["gpt_deployment"],
    name="cart-manager",
    description="MH Cart Manager Agent",
...
```plaintext
You are an intent classifier for MH shopping assistant.
...
description="MH Handoff Service Agent"
